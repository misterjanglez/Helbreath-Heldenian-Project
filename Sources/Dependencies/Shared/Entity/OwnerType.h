...
namespace hb::shared::owner {
	...
	// can_receive_items(). The server also uses this to check "is the actor near
	// an Auctioneer" (see trading_post_manager::is_near_auctioneer).
