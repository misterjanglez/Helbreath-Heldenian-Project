...
namespace MsgId
{
	enum : uint32_t
	{
		...
		ResponseCreateNewGuild                  = 0x0FC94209,
		...
		RequestFightZoneReserve                 = 0x12A01007,
		ResponseFightZoneReserve                = 0x12A01008,
...
namespace CommonType
{
	enum : uint16_t
	{
		...
		JoinGuildReject                         = 0x0A07,
		DismissGuildApprove                     = 0x0A08,
		DismissGuildReject                      = 0x0A09,
		ReleaseItem                             = 0x0A0A,
		...
		ClearGuildName                          = 0x0A25, // shares value 0x0A25 with ReqGetOccupyFightZoneTicket
		ReqGetOccupyFightZoneTicket             = 0x0A25, // shares value 0x0A25 with ClearGuildName
		BanGuild                                = 0x0A26,
		CraftItem                               = 0x0A28,
		...
		RequestHelp                             = 0x0A53,
		SetGuildTeleportLoc                     = 0x0A54,
		GuildTeleport                           = 0x0A55,
		SummonWarUnit                           = 0x0A56,
		SetGuildConstructLoc                    = 0x0A57,
		UpgradeItem                             = 0x0A58,
		ReqGuildName                            = 0x0A59,
...
namespace Notify
{
	...
	{
		ItemObtained                            = 0x0B01,
		QueryJoinGuildReqPermission             = 0x0B02,
		QueryDismissGuildReqPermission          = 0x0B03,
		WaitForGuildOperation                   = 0x0B04,
		...
		Killed                                  = 0x0B09,
		Exp                                     = 0x0B0A,
		GuildDisbanded                          = 0x0B0B,
		EventMsgString                          = 0x0B0C,
		CannotJoinMoreGuildsman                 = 0x0B0D,
		NewGuildsman                            = 0x0B0E,
		DismissGuildsman                        = 0x0B0F,
		...
		DamageMove                              = 0x0B74,
		ForceDisconn                            = 0x0B75,
		FightZoneReserve                        = 0x0B76,
		NoGuildMasterLevel                      = 0x0B77,
		SuccessBanGuildman                      = 0x0B78,
		CannotBanGuildman                       = 0x0B79,
