...
MUTABLE_COLUMNS = [
    ...
    "attack_dice_throw", "attack_dice_range", "attack_range", "abs_damage",
...
const FIELD_GROUPS = [
    ...
    { title: 'Combat', fields: [
        ...
        { key: 'attack_dice_throw', label: 'Atk Dice Throw', type: 'number' },
        { key: 'attack_dice_range', label: 'Atk Dice Range', type: 'number' },
